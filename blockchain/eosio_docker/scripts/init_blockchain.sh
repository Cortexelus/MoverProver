...
cleos wallet import -n eosiomain --private-key 5JpWT4ehouB2FF9aCfdfnZ5AwbQbTtHBAwebRXt94FmjyhXwL4K
cleos wallet import -n eosiomain --private-key 5JD9AGTuTeD5BXZwGQ5AtwBqHK21aHmYnTetHgk1B3pjj7krT8N
...
deploy_contract.sh mvpregister mvpregister notechainwal $(cat notechain_wallet_password.txt)
